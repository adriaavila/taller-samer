...
export const WORKERS_LIST: Worker[] = [
  ...
  },
  {
    id: "P-002",
    name: "Rosa Fernández",
    role: "Técnica hidráulica",
    specialty: "Bombas, sellos y cilindros",
    shift: "Mañana",
    status: "Asignado",
    phone: "+591 70123452",
    workload: 76,
    activeWorkOrderId: "OT-2026-014",
  },
  {
    id: "P-003",
    name: "Diego Mamani",
    role: "Técnico eléctrico",
    specialty: "Tableros, sensores y arranque",
    shift: "Tarde",
    status: "Disponible",
    phone: "+591 70123453",
    workload: 48,
  },
  {
    ...
    name: "Luis Quispe",
    role: "Soldador",
    specialty: "Estructuras y reparación de tolvas",
    shift: "Tarde",
    status: "En campo",
    phone: "+591 70123454",
    workload: 63,
    activeWorkOrderId: "OT-2026-012",
  },
  {
    id: "P-005",
    name: "Andrea Salvatierra",
    role: "Auxiliar de taller",
    specialty: "Apoyo operativo y checklist",
    shift: "Mañana",
    status: "Disponible",
    phone: "+591 70123455",
    workload: 35,
  },
  {
    id: "P-006",
    name: "Marco Ruiz",
    role: "Llantas y tren delantero",
    specialty: "Frenos, bujes y alineación",
    shift: "Mixto",
    status: "Descanso",
    phone: "+591 70123456",
    workload: 22,
